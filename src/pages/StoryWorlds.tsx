            ...
            <ContentCard
              ...
              description={
                <div className="flex flex-col gap-4 text-[13px] text-white/80 leading-relaxed">
                  ...
                  <p>
                    What Began As A Feature Film Has Evolved Into A Broader Ecosystem That Includes Educational Engagement, Youth Innovation Initiatives And The Makemation National Youth AI Festivals, Inspiring Young People To Imagine And Build The Future.
                  </p>
                </div>
              }
