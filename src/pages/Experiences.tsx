        ...
        <div className="relative z-10 mx-[5%] md:mx-[10%] pt-32">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Card 1 */}
              <div className="flex flex-col rounded-xl overflow-hidden border border-white/20 bg-primary-dark/30 backdrop-blur-sm">
                <div className="w-full aspect-square bg-accent-purple flex items-center justify-center p-8 relative">
                  <div className="absolute inset-0 bg-cover bg-center opacity-80" style={{ backgroundImage: 'url(/EXPERIENCE_STRATEGY_IMG.png)' }}></div>
                </div>
                <div className="p-6">
                  <h4 className="text-white font-bold mb-3">Experience Strategy</h4>
                  <p className="text-white/70 text-[13px] leading-relaxed">
                    Designing experiences aligned with audience needs, stakeholder objectives and long-term impact goals.
                  </p>
                </div>
              </div>
              ...
              {/* Card 2 */}
              <div className="flex flex-col rounded-xl overflow-hidden border border-white/20 bg-primary-dark/30 backdrop-blur-sm">
                <div className="w-full aspect-square bg-black flex items-center justify-center p-8 relative">
                  <div className="absolute inset-0 bg-cover bg-center opacity-80" style={{ backgroundImage: 'url(/CREATIVE_DIRECTION_IMG.png)' }}></div>
                </div>
                <div className="p-6">
                  <h4 className="text-white font-bold mb-3">Creative Direction</h4>
                  <p className="text-white/70 text-[13px] leading-relaxed">
                    Developing compelling concepts, narratives and audience journeys that bring experiences to life.
                  </p>
                </div>
              </div>
        ...
        <div className="relative z-10 mx-[5%] md:mx-[10%]">
          ...
          <div className="flex flex-col text-center items-center text-white mb-20">
            ...
            <div className="w-full relative">
              ...
              >
                {[
                  { title: "Artificial Intelligence", image: "/AI_FOCUS_IMG.png" },
                  { title: "Innovation & Technology", image: "/INNOVATION_FOCUS_IMG.png" },
                  { title: "Future Skills", image: "/SKILLS_FOCUS_IMG.png" },
                  { title: "Youth Development", image: "/YOUTH_FOCUS_IMG.png" }
                ].map((item, i) => (
                  <SwiperSlide key={i}>
                    <div className="flex flex-col items-center gap-6 group cursor-pointer">
                      <div className="w-full aspect-[4/3] rounded-2xl overflow-hidden shadow-lg relative bg-black/40 border border-white/10">
                        <img src={item.image} alt={item.title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" onError={(e) => {e.currentTarget.style.display='none'}} />
